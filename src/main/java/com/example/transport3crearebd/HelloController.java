...
//    public static String URLbackup = String.format( "jdbc:mariadb://95.214.135.69:3306/'"+backUpbazaDeDate+"'" );
    ...
    public static final String CREATE_AUTO_TBL= "CREATE TABLE IF NOT EXISTS auto (nrCrt INT(4) AUTO_INCREMENT PRIMARY KEY, nrInventar VARCHAR (15), nrInmatriculare VARCHAR (12), marca VARCHAR (30), model VARCHAR (15), tip VARCHAR (50), combustibil VARCHAR (20), anvelopeMarca VARCHAR (30) , anvelopeTip VARCHAR (30), serieSasiu VARCHAR (20), valAchizitie DOUBLE , dataAchizitiei DATE, dataPrimeiInmatr DATE, nrAxe INT(2), kmInitiali INT(7)    )";
    public static final String CREATE_RCA_ITP_AURORIZARI= "CREATE TABLE IF NOT EXISTS rcaITP (nrCrt INT(4) AUTO_INCREMENT PRIMARY KEY, nrInmatriculare VARCHAR (12), document VARCHAR (50), nrDoc VARCHAR (20), dataDoc DATE, valoare DOUBLE )";
    ...
    public static final String CREATE_COMBUSTIBILI= "CREATE TABLE IF NOT EXISTS combustibili (nrCrtCombust INT(4) AUTO_INCREMENT PRIMARY KEY, nrInmatriculare VARCHAR (12), cantitate  VARCHAR (6), kmLaAlimentare VARCHAR (7)  )";
...
//        Class.forName("org.mariadb.jdbc.Driver");
        ...
        statementINV.executeUpdate(CREATE_COMBUSTIBILI);
